...
**Filename** | **Version** | **Release Date** | **Notes** | **Documentation** |
 ----------- | ----------- | ---------------- | --------- | ----------------- |
 [hippylib-3.2.0.zip](https://zenodo.org/records/17914280/files/hippylib/hippylib-3.2.0.zip?download=1) | 3.2.0 | Dec 2025 | Time dependent problems | [html](https://hippylib.readthedocs.io/en/latest/)
